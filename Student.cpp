...
// Сформировать строку для экспорта из данных всех студентов,
// которая используется для записи базы данных в файл
